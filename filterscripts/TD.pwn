      ...
      //  Model Index\nRot X\nRot Y\nRot Z\nZoom
        ...
        case 1613: // Change textdraw's mode
        {
            if(response)
            {
                ...
                new string[128];
                format(string, sizeof(string), "Textdraw #%d's mode is GLOBAL.", pData[playerid][P_CurrentTextdraw]);
                SendClientMessage(playerid, MSG_COLOR, string);
                ShowTextDrawDialog(playerid, 5);
            }
            else
            {
                ...
                new string[128];
                format(string, sizeof(string), "Textdraw #%d's mode is PLAYER", pData[playerid][P_CurrentTextdraw]);
                SendClientMessage(playerid, MSG_COLOR, string);
                ShowTextDrawDialog(playerid, 5);
            }
        }
